...
public class MybatisPlusGenerator {
	public static void main(String[] args) throws InterruptedException {
      ...
      //项目名称
        String outputDir = "springboot-layui";
		...
		focList.add(new FileOutConfig("/mybatisplustemplates/entity.java.vm") {
		...
		tc.setEntity("mybatisplustemplates/entity.java.vm");

		//tc.setXml("...");

		tc.setService("mybatisplustemplates/service.java.vm");

		tc.setMapper("mybatisplustemplates/mapper.java.vm");
		tc.setServiceImpl("mybatisplustemplates/serviceImpl.java.vm");
		mpg.setTemplate(tc);
        // 执行生成
        mpg.execute();
	     // 打印注入设置
