...
````shell
mkdir -vp mysql/data mysql/logs mysql/conf
````
...
````shell
docker run --name 66nao-bi-db-container --network 66naocloud-debug-network -p 3356:3306 -e MYSQL_ROOT_PASSWORD=root -d mysql --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci --default_time-zone='+8:00' --sql-mode=STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION
````

### docker-compose安装mysql

````shell
mkdir -vp /usr/local/docker/mysql/data
````
...
![img](http://www.funtl.com/assets/18841d5327556bfa750148943011901d1eac3cd8.jpg) 
...
```
 ...
 ![img](http://www.funtl.com/assets/Lusifer1533594806.png) 